...
class UpdatePurchaseRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'details.*.id' => ['nullable', 'exists:purchase_details,id', Rule::exists('purchase_details', 'id')->where('purchase_id', $purchaseId)], // Validar que el detalle pertenezca a esta compra
    ...
    public function messages(): array
    {
        return [
            ...
            'details.*.id.exists' => 'El ID del detalle de compra no es válido.',
            'details.*.id.where' => 'El detalle de compra no pertenece a esta compra.',
